...
const NavPc = () => {
 ...
 <nav className={lightTheme?"navbar nav-light transition-theme":"navbar nav-dark transition-theme"}>
    <div className="flex content-center justify-start w-1/3 p-5 ">
        <Link href={"/"}><Image 
       src={'https://res.cloudinary.com/dttek3gqg/image/upload/v1744781034/logo_zk1qty.webp'} width={90} height={90}className=' rounded-full  ml-10' alt='logo' priority={true}/> </Link>
    </div>
